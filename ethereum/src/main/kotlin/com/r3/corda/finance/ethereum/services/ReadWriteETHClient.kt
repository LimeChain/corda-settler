...
import com.r3.corda.finance.ethereum.utilities.deserialize
import com.r3.corda.finance.ethereum.utilities.makeRequest
...
/**
 * An ETH client which can create and sign payment transactions for a specified account.
 */
interface ReadWriteETHClient : ReadOnlyETHClient {
