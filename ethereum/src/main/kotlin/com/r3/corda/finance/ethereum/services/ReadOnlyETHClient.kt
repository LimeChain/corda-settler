...
import com.r3.corda.finance.ethereum.utilities.*
import com.ripple.core.coretypes.AccountID
import java.net.URI

/** An ETH client which can obtain account and transaction information for any account. */
interface ReadOnlyETHClient {

    val nodeUri: URI

    fun <T : EthereumRpcException> handleErrors(response: String, map: Map<Int, Class<T>>) {
